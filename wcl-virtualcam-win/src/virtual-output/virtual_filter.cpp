...
static obs_properties_t *virtual_filter_properties(void *data)
{
	...
	obs_property_list_add_int(cb, "WCL-Camera", ModeVideo);
	obs_property_list_add_int(cb, "WCL-Camera2", ModeVideo2);
	obs_property_list_add_int(cb, "WCL-Camera3", ModeVideo3);
	obs_property_list_add_int(cb, "WCL-Camera4", ModeVideo4);
