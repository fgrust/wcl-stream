					  ...
					  .pixmap(QSize(20, 20)))
{
	...
	volumeLabel->setText(QString("VOL:"));
	...
	addPermanentWidget(volumeLabel);
	addPermanentWidget(volMeter);
...
void OBSBasicStatusBar::AttachSource(OBSSource source)
{
	if (obs_volmeter)
		obs_volmeter_attach_source(obs_volmeter, source);
}

void OBSBasicStatusBar::OBSVolumeLevel(void *data,
				...
				const float inputPeak[MAX_AUDIO_CHANNELS])
{
	...
	statusBar->volMeter->setLevels(magnitude, peak, inputPeak);
}
